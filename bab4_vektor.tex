...
\begin{itemize}
\item{Luas jajaran genjang yang dibentuk $\vec{a}$ dan $\vec{b}$}
\includegraphics[width=1.5in]{pict/jajar_genjang}
\begin{center}
\fbox{$L_{jajargenjang} = |\vec{a} \times \vec{b}| = ab \sin \theta$}
\end{center}
\item{Penulisan disingkat}
\item {Rumus} \\
\begin{center}
\fbox{$\vec{a} \times \vec{b} = \begin{vmatrix}
\vec{i} & \vec{j} & \vec{k} \\
a_1 & a_2 & a_3 \\
b_1 & b_2 & b_3
\end{vmatrix}$}
...
\item{Rumus} \\
\begin{center}
\fbox{$\vec{a} \times (\vec{b} \times \vec{c}) = (\vec{a} \cdot \vec{c})\vec{b} - (\vec{a} \cdot \vec{b}) \vec{c}$}
\end{center}
\end{itemize}
\end{frame}
